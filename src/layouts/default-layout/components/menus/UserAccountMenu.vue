<template>
  ...
  >
    ...
    <div class="menu-item px-3">
      <div class="menu-content d-flex align-items-center px-3">
        ...
        <div class="d-flex flex-column">
          ...
          <span class="fw-semibold text-muted text-hover-primary fs-7">Sales Executive</span>
        </div>
        <!--end::Username-->
      </div>
    </div>
    ...
    <div class="menu-item px-5">
      <router-link to="/pages/account/overview" class="menu-link px-5">
        Profile
      </router-link>
    </div>
    <!--end::Menu item-->
    ...
    <div class="menu-item px-5 my-1">
      <router-link to="/pages/account/settings" class="menu-link px-5">
        Settings
      </router-link>
    </div>
    <!--end::Menu item-->
