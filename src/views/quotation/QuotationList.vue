    ...
    <div class="card-header pt-5">
      ...
      <div class="card-toolbar">
        <button class="btn btn-sm btn-primary" @click="comingSoon()">
          <KTIcon icon-name="plus-square" icon-class="fs-3" /> New Quotation
        </button>
      </div>
      <!--end::Toolbar-->
    </div>
              ...
              <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                ...
                <thead>
                  <tr class="fs-7 fw-bold text-gray-500 border-bottom-0">
                    <th class="p-0 pb-3 min-w-150px text-start">Quote Name</th>
                    <th class="pb-3 min-w-150px text-start">Customer</th>
